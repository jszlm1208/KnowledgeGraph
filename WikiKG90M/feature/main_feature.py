...
def main(gpu, output_path, data_path):
   ...
   # del data_t2r
    ...
    # data_r2t = pickle.load(open(prob_dir + "/feature_output/r2t_prob.pkl", "rb"))
    # data_t2r = pickle.load(open(prob_dir + "/feature_output/t2r_prob.pkl", "rb"))

    
    data_t2h = pickle.load(open(os.path.join(prob_dir,"feature_output/t2h_prob.pkl"),"rb"))
    data_t2r = pickle.load(open(os.path.join(prob_dir,"feature_output/t2r_prob.pkl"),"rb"))
    data_h2t = pickle.load(open(os.path.join(prob_dir,"feature_output/h2t_prob.pkl"),"rb"))
    data_h2r = pickle.load(open(os.path.join(prob_dir,"feature_output/h2r_prob.pkl"),"rb"))
    data_r2t = pickle.load(open(os.path.join(prob_dir,"feature_output/r2t_prob.pkl"),"rb"))
    data_r2h = pickle.load(open(os.path.join(prob_dir,"feature_output/r2h_prob.pkl"),"rb"))
    
    
    

    # data_t2h = pickle.load(open(prob_dir + "/feature_output/t2h_prob.pkl", "rb"))
    # data_h2t = pickle.load(open(prob_dir + "/feature_output/h2t_prob.pkl", "rb"))
    ...
    datastore.upload(output_path, 'OTE_manual_features/',
        overwrite=True)    
